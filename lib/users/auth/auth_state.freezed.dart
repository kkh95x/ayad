...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthStatus authStatus, AppUser? currentUser});
...
class _$AuthStateImpl with DiagnosticableTreeMixin implements _AuthState {
  _$AuthStateImpl({required this.authStatus, this.currentUser});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AuthState(authStatus: $authStatus, currentUser: $currentUser)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, authStatus, currentUser);
...
abstract class _AuthState implements AuthState {
  factory _AuthState(
      ...
      final AppUser? currentUser}) = _$AuthStateImpl;
